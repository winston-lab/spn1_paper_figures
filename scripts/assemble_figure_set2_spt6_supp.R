...
main = function(set2_spt6_v_rpb1_rdata,
                ...
                elongation_spn1_depletion_westerns_rdata,
                fig_width=8.5,
    ...
    load(elongation_spn1_depletion_westerns_rdata)

    figure_set2_spt6_supp = arrangeGrob(set2_spt6_v_rpb1,
                                        set2_spt6_rpb1norm_v_rpb1,
                                        elongation_spn1_depletion_westerns,
...
main(set2_spt6_v_rpb1_rdata = snakemake@input[["set2_spt6_v_rpb1"]],
     ...
     elongation_spn1_depletion_westerns_rdata = snakemake@input[["elongation_spn1_depletion_westerns"]],
